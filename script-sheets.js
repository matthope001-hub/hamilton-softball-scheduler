...
class MarchMadnessBracket {
    ...
    initializeTeams() {
        return {
            // 2026 March Madness Teams - Updated with realistic projections
            midwest: [
                { seed: 1, name: "Houston" },
                { seed: 16, name: "Northern Kentucky" },
                { seed: 8, name: "Texas A&M" },
                { seed: 9, name: "Drake" },
                { seed: 5, name: "Miami" },
                { seed: 12, name: "UC Santa Barbara" },
                { seed: 4, name: "Kansas" },
                { seed: 13, name: "Samford" },
                { seed: 6, name: "Creighton" },
                { seed: 11, name: "Oregon" },
                { seed: 3, name: "Marquette" },
                { seed: 14, name: "Colgate" },
                { seed: 7, name: "Michigan State" },
                { seed: 10, name: "UNLV" },
                { seed: 2, name: "Iowa State" },
                { seed: 15, name: "Western Kentucky" }
            ],
            west: [
                { seed: 1, name: "Alabama" },
                { seed: 16, name: "Texas A&M-Commerce" },
                { seed: 8, name: "Northwestern" },
                { seed: 9, name: "Washington State" },
                { seed: 5, name: "Saint Mary's" },
                { seed: 12, name: "Vermont" },
                { seed: 4, name: "Arizona" },
